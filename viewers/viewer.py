...
class Viewer(QMainWindow):
    def __init__(self, path=None, min1=0, max1=0, resolution=0, av=0, lcd=0, noise=0, homogeneity=0, mean1=0):
        ...
        self.D_Phantom = True
        scroll_area = QtWidgets.QScrollArea(None)  # 滚动窗口，包含大部分窗口部件，目前未实现滚动
        ...
        hbox1.addWidget(self.water_checkbox1, alignment=Qt.Alignment())  # , 0, 0, 1, 1)
        hbox1.addWidget(self.water_label_lcd_2, alignment=Qt.Alignment())  # , 0, 1, 1, 1)
        hbox1.addWidget(self.water_lineEdit_lcd_2, alignment=Qt.Alignment())  # , 0, 2, 1, 3)

        hbox1.addWidget(self.water_checkbox2, alignment=Qt.Alignment())  # , 0, 5, 1, 1)
        hbox1.addWidget(self.water_label_lcd_3, alignment=Qt.Alignment())  # , 0, 6, 1, 1)
        hbox1.addWidget(self.water_lineEdit_lcd_3, alignment=Qt.Alignment())  # , 0, 7, 1, 3)

        hbox2.addWidget(self.water_checkbox3, alignment=Qt.Alignment())  # , 1, 0, 1, 1)
        hbox2.addWidget(self.water_label_lcd_5, alignment=Qt.Alignment())  # , 1, 1, 1, 1)
        hbox2.addWidget(self.water_lineEdit_lcd_5, alignment=Qt.Alignment())  # , 1, 2, 1, 3)

        hbox2.addWidget(self.water_checkbox4, alignment=Qt.Alignment())  # , 1, 5, 1, 1)
        hbox2.addWidget(self.water_label_lcd_7, alignment=Qt.Alignment())  # , 1, 6, 1, 1)
        hbox2.addWidget(self.water_lineEdit_lcd_7, alignment=Qt.Alignment())  # , 1, 7, 1, 3)
        ...
        # self.sliceThickness_lineEdit_bc8R =  QLineEdit(self.groupBox_sliceThickness)
        ...
        # self.sliceThickness_lineEdit_bc28R =  QLineEdit(self.groupBox_sliceThickness)
        ...
        # self.sliceThickness_lineEdit_bc2R =  QLineEdit(self.groupBox_sliceThickness)
        ...
        # self.sliceThickness_lineEdit_bc8R.setObjectName(_fromUtf8("sliceThickness_lineEdit_bc8R"))
        ...
        # self.sliceThickness_lineEdit_bc28R.setObjectName(_fromUtf8("sliceThickness_lineEdit_bc28R"))
        ...
        # self.sliceThickness_lineEdit_bc2R.setObjectName(_fromUtf8("sliceThickness_lineEdit_bc2R"))
        ...
        # self.gridLayout_sliceThickness.addWidget(self.sliceThickness_lineEdit_bc8R, 1, 3, 1, 1)
        ...
        # self.gridLayout_sliceThickness.addWidget(self.sliceThickness_lineEdit_bc28R, 5, 3, 1, 1)
        ...
        # self.gridLayout_sliceThickness.addWidget(self.sliceThickness_lineEdit_bc2, 9, 3, 1, 1)
        ...
        self.sliceThickness_lineEdit_shice8L.setEnabled(0)
        self.sliceThickness_lineEdit_error8L.setEnabled(0)
        # self.sliceThickness_lineEdit_bc8.setEnabled(0)
        self.sliceThickness_lineEdit_shice8R.setEnabled(0)
        self.sliceThickness_lineEdit_error8R.setEnabled(0)
        ...
        self.linear_lineEdit_ctceliang8.setEnabled(0)
        self.linear_lineEdit_ctceliang9.setEnabled(0)
        self.linear_lineEdit_ctceliang10.setEnabled(0)
        ...
        self.sliceThickness_lineEdit_shice28L.setEnabled(0)
        self.sliceThickness_lineEdit_bc28.setEnabled(0)
        self.sliceThickness_lineEdit_shice28R.setEnabled(0)
        # self.sliceThickness_lineEdit_bc28.setEnabled(0)
        self.water_lineEdit_lcd_5.setEnabled(0)
        self.water_lineEdit_lcd_7.setEnabled(0)
        self.resolution_lineEdit_G_10.setEnabled(0)
        self.sliceThickness_lineEdit_error28L.setEnabled(0)
        self.sliceThickness_lineEdit_bc2.setEnabled(0)
        self.sliceThickness_lineEdit_shice2L.setEnabled(0)
        self.sliceThickness_lineEdit_error2L.setEnabled(0)
        self.sliceThickness_lineEdit_error28R.setEnabled(0)
        # self.sliceThickness_lineEdit_bc2.setEnabled(0)
        self.sliceThickness_lineEdit_shice2R.setEnabled(0)
        self.sliceThickness_lineEdit_error2R.setEnabled(0)
    ...
    def button_click_slice2(self):
        ...
        try:
            if self.orientation == 2:  # 横截面
                ...
                thickness = [-1,-1]
            if thickness == [-1,-1] or thickness == None:
                QMessageBox.information(self,
                                        '出错',
                                        '当前图像无法测量层厚！',
                                        QMessageBox.Ok)
    ...
    def button_click_saveReport(self):
        ...
        oldWb = xlrd.open_workbook("template.xls", formatting_info=True)
    ...
    def ImageInfo(self):
        ...
        try:
            ...
            QMessageBox.information(self,
                                    ...
                                    data_element0.value, data_element1.value, data_element2.value, data_element3.value,
    ...
    def get_coordinates(self, i, j):  # 没有属性
    ...
    #         vbox0.addWidget(sForDataBtn,alignment=Qt.Alignment())
    # ##        vbox0.addWidget(sForCanvasBtn)
    #         vbox0.addWidget(sCancelBtn,alignment=Qt.Alignment())
    ...
    #             vbox1 =  QVBoxLayout()
    #             hbox1 = QHBoxLayout()
    #             hbox1.addWidget(okBtn,alignment=Qt.Alignment())
    #             hbox1.addWidget(CcBtn,alignment=Qt.Alignment())
    #             vbox1.addWidget(DataEdit,alignment=Qt.Alignment())
    ...
    def progress_wa(self):
        ...
        vbox.addWidget(Progress, alignment=Qt.Alignment())
    ...
    def progress_th(self):
        ...
        vbox.addWidget(self.Progress, alignment=Qt.Alignment())
        ...
        print('new add:'+QFileDialog.getSaveFileName(
            self,
            "Save file",
    ...
    def chooseFile(self):
        ...
        vbox.addWidget(scroll, alignment=Qt.Alignment())
        vbox.addWidget(selectBtn, alignment=Qt.Alignment())
        ...
        hboxj.addWidget(label_junyun1, alignment=Qt.Alignment())
        hboxj.addWidget(label_junyun2, alignment=Qt.Alignment())
        hboxj.addWidget(lineEdit_junyun, alignment=Qt.Alignment())
        hboxj.addWidget(okBtn1, alignment=Qt.Alignment())
        label_ge1 = QLabel("每n层抽取一层")
        label_ge2 = QLabel(" n = ")
        lineEdit_ge = QLineEdit()
        okBtn2 = QPushButton("确定")
        hboxg = QHBoxLayout()  # 横向布局
        hboxg.addWidget(label_ge1, alignment=Qt.Alignment())
        hboxg.addWidget(label_ge2, alignment=Qt.Alignment())
        hboxg.addWidget(lineEdit_ge, alignment=Qt.Alignment())
        hboxg.addWidget(okBtn2, alignment=Qt.Alignment())
        okBtn = QPushButton("确定")
        cancelBtn = QPushButton("取消")
        vbox.addLayout(hboxj)
        vbox.addLayout(hboxg)
        hboxs = QHBoxLayout()  # 横向布局
        hboxs.addWidget(okBtn, alignment=Qt.Alignment())
        hboxs.addWidget(cancelBtn, alignment=Qt.Alignment())
        vBox.addWidget(groupBox, alignment=Qt.Alignment())
...
if __name__ == "__main__":
    ...
    ##    font.setPixelSize(pointsize/dpi*100)
    ##    print(font.HintingPreference())
    ##    app.setFont(font)
    ui = Viewer(path)
    ui.show()
    sys.exit(app.exec_())
